...
// www.https://samuelchukwuemeka.github.io/forecastingmodels
...
document
  .getElementById("formMeanAbsoluteDeviation")
  .addEventListener("submit", formMeanAbsoluteDeviation);
...
function formMeanAbsoluteDeviation(event) {
  ...
  if (sampleSizeActual !== sampleSizeForecast) {
    alert(
      "Please make sure the two sample sizes are equal. Set the first value of the Forecast to be the first value of the Actual.",
    );
  }
